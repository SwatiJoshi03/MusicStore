...
<center><table border="5" bgcolor="Lavender"> <h2><font><b>Customer Details for the order</b></font></h2><br><a href="order.php">HOME</a>&nbsp&nbsp&nbsp&nbsp<a href="update.php">UPDATE</a>&nbsp&nbsp&nbsp&nbsp<a href="delete.php">DELETE</a>&nbsp&nbsp&nbsp&nbsp<a href="search.php">SEARCH</a><br><br></center>
        <tr>
		<td>CUSTOMER ID:</td>
...
if(isset($_POST['submit']))
 ...
 $q1=mysql_query("insert into customer(CUSTOMER_ID,FIRSTNAME,LASTNAME,EMAIL,PHONE,ADDRESS,STREET,CITY,PINCODE,DATE) values('$cid','$cap1','$cap2','$email','$phone','$address','$street','$city','$pin','$dd $mm $yy')");
if($q1)
{
