...
if(isset($_POST['submit']))
 ...
 $q1=mysql_query("UPDATE customer SET CUSTOMER_ID='$cid',FIRSTNAME='$cap1',LASTNAME='$cap2',EMAIL='$email',PHONE='$phone',ADDRESS='$address',STREET='$street',CITY='$city',PINCODE='$pin',DATE='$dd $mm $yy' where CUSTOMER_ID =$cid");
if($q1)
{
